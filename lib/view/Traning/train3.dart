...
import 'package:fitnessapp/view/Traning/videoInfo3.dart';
import 'package:flutter/material.dart';
import 'package:fitnessapp/utils/app_colors.dart';


class train3 extends StatefulWidget {
  static String routeName = "/train3";

  train3({Key? key}) : super(key: key);

  @override
  _train3State createState() => _train3State();
}

class _train3State extends State<train3> {
  List info = [];
  ...
  void _initData() {
    DefaultAssetBundle.of(context).loadString("json/info3.json").then((value) {
      setState(() {
              ...
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [
                      ...
                      Color(0xfff48fb1).withOpacity(0.6),
                    ],
