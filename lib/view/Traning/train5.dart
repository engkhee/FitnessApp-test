...
import 'package:fitnessapp/view/Traning/videoInfo5.dart';
import 'package:flutter/material.dart';
import 'package:fitnessapp/utils/app_colors.dart';


class train5 extends StatefulWidget {
  static String routeName = "/train5";

  train5({Key? key}) : super(key: key);

  @override
  _train5State createState() => _train5State();
}

class _train5State extends State<train5> {
  List info = [];
  ...
  void _initData() {
    DefaultAssetBundle.of(context).loadString("json/info5.json").then((value) {
      setState(() {
