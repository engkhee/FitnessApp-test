...
class VideoInfo3 extends StatefulWidget{
  ...
  @override
  _VideoInfo3State createState() => _VideoInfo3State();
}
...
class _VideoInfo3State extends State<VideoInfo3>{
  ...
  Future<void> _initData() async {
    String data = await DefaultAssetBundle.of(context).loadString("json/videoinfo3.json");
            ...
            RoundButton(
              onPressed: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => train3())); // Navigate to the training page
              },
              title: 'OK',
            ),
          ],
              ...
              Container(
                ...
                child: Center(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 15,
                      color: Color(0xffc51162).withOpacity(0.3),
                    ),
                  ),
                ),
              ),
