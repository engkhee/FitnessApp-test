...
class VideoInfo4 extends StatefulWidget{
  ...
  @override
  _VideoInfo4State createState() => _VideoInfo4State();
}
...
class _VideoInfo4State extends State<VideoInfo4>{
  ...
  Future<void> _initData() async {
    String data = await DefaultAssetBundle.of(context).loadString("json/videoinfo4.json");
            ...
            RoundButton(
              onPressed: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => train4())); // Navigate to the training page
              },
              title: 'OK',
            ),
          ],
