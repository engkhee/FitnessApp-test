  ...
  List<PieChartSectionData> _getSections(double totalProtein, double totalCarbohydrate, double totalFat) {
    return [
      PieChartSectionData(
        ...
        value: totalProtein,
        title: '${((totalProtein / (totalProtein + totalCarbohydrate + totalFat)) * 100).toStringAsFixed(1)}%',
        radius: 30,
      ...
      PieChartSectionData(
        ...
        title: '${((totalCarbohydrate / (totalProtein + totalCarbohydrate + totalFat)) * 100).toStringAsFixed(1)}%',
        radius: 30,
        titleStyle: const TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: AppColors.black),
      ),
      PieChartSectionData(
        ...
        value: totalFat,
        title: '${((totalFat / (totalProtein + totalCarbohydrate + totalFat)) * 100).toStringAsFixed(1)}%',
        radius: 30,
        titleStyle: const TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: AppColors.black),
      ),
    ];
