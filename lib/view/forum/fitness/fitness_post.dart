...
class FitnessPost extends StatefulWidget{
  ...
  @override
  State<FitnessPost> createState() => _PostState();
}

class _PostState extends State<FitnessPost> {
  ...
  void toggleLike(){
    ...
    DocumentReference postRef = FirebaseFirestore.instance.collection("FitnessPosts").doc(widget.postId);
      ...
      builder: (context) => AlertDialog(
        ...
        actions: <Widget>[
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              primary: AppColors.lightgreenColor , // Background color of the button
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(8),
              ),
            ),
...
// Method to update the post in Firestore
  void updatePost(String newMessage) {
    FirebaseFirestore.instance.collection("FitnessPosts").doc(widget.postId).update({
      "Message": newMessage,
    }).then((_) {
